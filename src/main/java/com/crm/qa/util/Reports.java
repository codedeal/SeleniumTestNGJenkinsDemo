...
{
	private static ExtentReports extent = ExtentManager.createInstance("test.html");
    ...
    public synchronized void  onStart(ITestContext result)
    {
        ...
        //ExtentTest parent=extent.createTest(result.getSuite().getXmlSuite().getTest().toString());
        //result.getSuite().getXmlSuite().getTest().toString()
    ...
    public synchronized void onTestSuccess(ITestResult result) {
        ...
        // screenShotPath = GetScreenShot.capture( result.getName());
    ...
    public synchronized void onTestFailure(ITestResult result) {
        ...
        //String screenShotPath = GetScreenShot.capture( result.getName());
